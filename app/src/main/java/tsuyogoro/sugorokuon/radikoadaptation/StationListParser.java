...
public class StationListParser extends ParserBase {

	public static enum LogoSize {
		XSMALL, // 105 x 33
		SMALL,  // 114 x 40
		MEDIUM, // 123 x 50
		LARGE;  // 216 x 54
	...
	private final LogoSize mLogoSize;
	 ...
	 */
	public StationListParser(InputStream source, LogoSize logoSize, String inputEncoding) {
