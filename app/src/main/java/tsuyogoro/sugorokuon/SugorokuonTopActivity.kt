...
class SugorokuonTopActivity : AppCompatActivity() {
    ...
    private var recommendUpdaterDisposable: Disposable? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recommendModuleDependencyResolver.getRecommendUpdater(this)?.let {
            recommendUpdaterDisposable = it
                .observeRecommendConditionAndUpdate()
    ...
    override fun onDestroy() {
        super.onDestroy()
        recommendUpdaterDisposable?.dispose()
    }
    ...
    fun gotoRecoomendKeywordSettings() {
        recommendModuleDependencyResolver.getRecommendKeywordSettingsFragment()?.let {
