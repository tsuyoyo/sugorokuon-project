...
class ProgramTableFragment : Fragment(),
    ...
    override fun onRecommendModuleInstallCompleted() {
        activity?.let {
            it.finish()
            startActivity(Intent(it, SugorokuonTopActivity::class.java))
        }
    }

    override fun onRecommendModuleInstallStarted() {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun onRecommendModuleInstallError() {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
